...
func TestScoutingReport_reportsFirstPassCatchRateOverCompletedPackets(t *testing.T) {
	t.Parallel()
	l, _ := openLog(t)
	for i := 0; i < 3; i++ {
...
func TestScoutingReport_countsOnlyCompletedPackets(t *testing.T) {
	t.Parallel()
	l, _ := openLog(t)
...
func TestScoutingReport_excludesFailedPacketsFromTheRate(t *testing.T) {
	t.Parallel()
	l, _ := openLog(t)
	require.NoError(t, l.Append(distinctRecord(0)))
	require.NoError(t, l.Append(distinctRecord(1)))
...
func TestScoutingReport_doesNotCountACatchOnAnUncompletedPacket(t *testing.T) {
	t.Parallel()
	l, _ := openLog(t)
	require.NoError(t, l.Append(distinctRecord(0)))
	require.NoError(t, l.AppendSend("d1", target(1), ownTarget()))
...
func TestScoutingReport_isEmptyForASessionWithNoCompletedPackets(t *testing.T) {
	t.Parallel()
	l, _ := openLog(t)
